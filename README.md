# Tukka Learn Javascript Projects
...
```bash
git clone -b starter --single-branch  https://github.com/tukkaLearn/javascript_project.git
```

- Clone Main Branch

```bash
git clone -b main --single-branch  https://github.com/tukkaLearn/javascript_project.git
```
